...
(function () {
  ...
  const mappers = {
    ...
    bienes: {
      toApi:   b => ({ nombre: b.nombre, tipo: b.tipo, ubicacion: b.ubicacion, precio_compra: b.precioCompra, gastos_notariales: b.gastosNotariales || 0, escrituracion: b.escrituracion || 0, impuesto_adquisicion: b.impuestoAdquisicion || 0, otros_gastos: b.otrosGastos || 0, valor_actual: b.valorActual, saldo_hipoteca: b.saldoHipoteca || 0, renta_mensual: b.rentaMensual || 0 }),
      fromApi: b => ({ id: b.id, nombre: b.nombre, tipo: b.tipo, ubicacion: b.ubicacion, precioCompra: parseFloat(b.precio_compra), gastosNotariales: parseFloat(b.gastos_notariales), escrituracion: parseFloat(b.escrituracion), impuestoAdquisicion: parseFloat(b.impuesto_adquisicion), otrosGastos: parseFloat(b.otros_gastos), valorActual: parseFloat(b.valor_actual), saldoHipoteca: parseFloat(b.saldo_hipoteca), rentaMensual: parseFloat(b.renta_mensual), history: _fakeHistory(parseFloat(b.valor_actual)) }),
    },
    crypto: {
