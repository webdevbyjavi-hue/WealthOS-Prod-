...
(function () {
  ...
  const mappers = {
    ...
    bienes: {
      toApi:   b => ({ nombre: b.nombre, tipo: b.tipo, ubicacion: b.ubicacion || '', precio_compra: b.precioCompra, valor_actual: b.valorActual || b.precioCompra, gastos_notariales: b.gastosNotariales || 0, escrituracion: b.escrituracion || 0, impuesto_adquisicion: b.impuestoAdquisicion || 0, otros_gastos: b.otrosGastos || 0, saldo_hipoteca: b.saldoHipoteca || 0, renta_mensual: b.rentaMensual || 0 }),
      fromApi: b => ({ id: b.id, nombre: b.nombre, tipo: b.tipo, ubicacion: b.ubicacion || '', precioCompra: parseFloat(b.precio_compra), valorActual: parseFloat(b.valor_actual) || parseFloat(b.precio_compra), gastosNotariales: parseFloat(b.gastos_notariales) || 0, escrituracion: parseFloat(b.escrituracion) || 0, impuestoAdquisicion: parseFloat(b.impuesto_adquisicion) || 0, otrosGastos: parseFloat(b.otros_gastos) || 0, saldoHipoteca: parseFloat(b.saldo_hipoteca) || 0, rentaMensual: parseFloat(b.renta_mensual) || 0, history: _fakeHistory(parseFloat(b.valor_actual) || parseFloat(b.precio_compra)) }),
    },
    crypto: {
