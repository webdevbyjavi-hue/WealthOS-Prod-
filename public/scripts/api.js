...
(function () {
  ...
  const mappers = {
    ...
    bienes: {
      toApi:   b => ({ nombre: b.nombre, tipo: b.tipo, ubicacion: b.ubicacion, precio_compra: b.precioCompra, valor_actual: b.valorActual || b.precioCompra, fecha_compra: b.fechaCompra || null, plusvalia_anual: b.plusvaliaAnual || 0, gastos_notariales: b.gastosNotariales || 0, escrituracion: b.escrituracion || 0, impuesto_adquisicion: b.impuestoAdquisicion || 0, otros_gastos: b.otrosGastos || 0, saldo_hipoteca: b.saldoHipoteca || 0, renta_mensual: b.rentaMensual || 0 }),
      fromApi: b => ({ id: b.id, nombre: b.nombre, tipo: b.tipo, ubicacion: b.ubicacion, precioCompra: parseFloat(b.precio_compra), valorActual: parseFloat(b.valor_actual) || parseFloat(b.precio_compra), fechaCompra: b.fecha_compra || null, plusvaliaAnual: parseFloat(b.plusvalia_anual) || 0, gastosNotariales: parseFloat(b.gastos_notariales), escrituracion: parseFloat(b.escrituracion), impuestoAdquisicion: parseFloat(b.impuesto_adquisicion), otrosGastos: parseFloat(b.otros_gastos), saldoHipoteca: parseFloat(b.saldo_hipoteca), rentaMensual: parseFloat(b.renta_mensual), history: _fakeHistory(parseFloat(b.valor_actual) || parseFloat(b.precio_compra)) }),
    },
    crypto: {
